  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        stage: {
          narrative: "hsl(var(--stage-narrative))",
          director_brief: "hsl(var(--stage-director))",
          elements: "hsl(var(--stage-elements))",
          vision: "hsl(var(--stage-vision))",
          storyboard: "hsl(var(--stage-storyboard))",
          assembly: "hsl(var(--stage-assembly))",
          export: "hsl(var(--stage-export))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        "glow-golden": "0 0 20px -5px hsl(var(--golden) / 0.4)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
